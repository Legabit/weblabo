...
GREETING_RESPONSES = ["'sup bro", "hey", "*nods*", "hey you get my snap?","Que onda"]
...
NONE_RESPONSES = [
    "uh whatever",
    "meet me at the football field, bro?",
    "tackle hard bro",
    "want to bro down and crush it?",
    "I'd like to add you to my fantasy football",
    "Have you closed your seed draft picks?",
]
# end
