...
PAGE_ACCESS_TOKEN = "EAAPKlAdP1M8BAKJFNxE5ClglkT72ZCZAvrWcdT35BPsUtt3hQ0OEyHeSYv8WXoLKGPnpltgmYd4N0j82kpgJSw0DJOogI6ZBQhvKcjAZCDZCaDroT2peZCNDkafXKyYP3FfpnPdFBZAkg3fVcWKVwZAZBUjxtwk2kTWO9GzlMHiRQuQZDZD"
# Token generado por nosotros. Token generated by us
VERIFY_TOKEN = "ChatBotDocker" # Si cambias este token, asegúrate de cambiarlo también en la página de configuración del webhook. If you change this token, verify that you changed it too in the webhook configuration.
...
def message_handler(event):
    ...
    if event.is_text_message:
        ...
        botanswer = broback(event.message_text)
        page.send(sender_id, botanswer)
